...
## 소개
초기에는 풀스택 개발을 경험했고 이후 요기요에서 대규모 트래픽 환경을 경험하며 백엔드 개발자로 전환했습니다.  
스타트업 환경에서 백엔드, 인프라, 아키텍처 설계까지 전반적인 플랫폼 개발을 담당해 왔습니다.  
최근에는 Claude Code를 활용해 개발 생산성을 높이고 있습니다.
...
- 메뉴 권한은 LNB 메뉴 구성에 사용되며, 기능 권한은 해당 메뉴 내 개별 기능에 대한 접근 제어를 담당
